    ...
    if (!post) {
        return (
            <div className="min-h-screen pt-32 text-center bg-black">
                ...
                <Link to="/blog" className="text-brand-accent uppercase tracking-widest font-bold">&larr; Back to Community Feed</Link>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <article className="prose prose-invert prose-brand max-w-none">
                    {(() => {
                        ...
                        const renderedContent = /<\/?[a-z][\s\S]*>/i.test(rawContent)
                            ? rawContent
                            : rawContent.replace(/\n/g, '<br />');
