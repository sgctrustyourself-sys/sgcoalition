...
const Shop = () => {
    ...
    // Derived Data
    const validCategories = ['all', 'shirt', 'wallet', 'accessory', 'apparel', 'jeans'];
    const dynamicCategories = Array.from(new Set(products.map(p => p.category.toLowerCase())));
    const categories = Array.from(new Set([...validCategories, ...dynamicCategories]));
