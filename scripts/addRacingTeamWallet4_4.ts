// scripts/addRacingTeamWallet4_4.ts
//
// Upsert the Coalition 'Racing Team' Wallet 4/4 row into the live Supabase
...
async function addRacingTeamWallet4_4() {
    console.log("🏎️  Adding Coalition 'Racing Team' Wallet 4/4...");
    ...
    const product = {
        ...
        images: [
            PRODUCT_IMAGE_URLS.racingTeamWallet4_4.front,
            PRODUCT_IMAGE_URLS.racingTeamWallet4_4.back,
        ],
        description:
            "Fourth and final piece of the Coalition 'Racing Team' limited wallet run. Hand-finished detailing and Coalition mark on a numbered carry. Sold as part of the May 2026 wholesale bundle — once sold, gone forever.",
        category: 'wallet',
        is_featured: false,
    ...
    if (error) {
        console.error('❌ Error upserting Coalition Racing Team Wallet 4/4:', error);
    ...
    console.log("✅ Successfully upserted Coalition 'Racing Team' Wallet 4/4:", data);
    console.log('🔗 View at: https://sgcoalition.xyz/product/Coalition_Racing_Team_Wallet_4_4');
}

addRacingTeamWallet4_4();
