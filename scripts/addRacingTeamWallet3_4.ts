// scripts/addRacingTeamWallet3_4.ts
//
// Upsert the Coalition 'Racing Team' Wallet 3/4 row into the live Supabase
...
//
// Wholesale bundle context (see also: 1_4, 2_4, 4_4):
// 7 wallets sold to @friiqy on 2026-05-22. INITIAL_ORDERS
// .public-md-wholesale-wallets-2026_05_22.
//
// USAGE:  npx tsx scripts/addRacingTeamWallet3_4.ts
...
async function addRacingTeamWallet3_4() {
    console.log("🏎️  Adding Coalition 'Racing Team' Wallet 3/4...");
    ...
    const product = {
        ...
        images: [
            PRODUCT_IMAGE_URLS.racingTeamWallet3_4.front,
            PRODUCT_IMAGE_URLS.racingTeamWallet3_4.back,
        ],
        description:
            "Third piece of the Coalition 'Racing Team' limited wallet run. Hand-finished detailing and Coalition mark on a numbered carry. Sold as part of the May 2026 wholesale bundle — once sold, gone forever.",
        category: 'wallet',
        is_featured: false,
    ...
    if (error) {
        console.error('❌ Error upserting Coalition Racing Team Wallet 3/4:', error);
    ...
    console.log("✅ Successfully upserted Coalition 'Racing Team' Wallet 3/4:", data);
    console.log('🔗 View at: https://sgcoalition.xyz/product/Coalition_Racing_Team_Wallet_3_4');
}

addRacingTeamWallet3_4();
